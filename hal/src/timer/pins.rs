...
pub(crate) mod sealed {
    pub trait Remap {
        ...
        fn remap(pcfr: &mut crate::afio::PCFR);
    }
}
...
remap!(
    Tim2NoRemap: (pac::TIM2, 0b00, PA0, PA1, PA2, PA3, {|_, w| unsafe { w.tim2rm().bits(Self::REMAP)}}),
    Tim2PartialRemap1: (pac::TIM2, 0b01, PA15, PB3, PA2, PA3, {|_, w| unsafe { w.tim2rm().bits(Self::REMAP)}}),
    Tim2PartialRemap2: (pac::TIM2, 0b10, PA0, PA1, PB10, PB11, {|_, w| unsafe { w.tim2rm().bits(Self::REMAP)}}),
    Tim2FullRemap: (pac::TIM2, 0b11, PA15, PB3, PB10, PB11, {|_, w| unsafe { w.tim2rm().bits(Self::REMAP)}}),

    Tim3NoRemap: (pac::TIM3, 0b00, PA6, PA7, PB0, PB1, {|_, w| unsafe { w.tim3rm().bits(Self::REMAP)}}),
    Tim3PartialRemap: (pac::TIM3, 0b10, PB4, PB5, PB0, PB1, {|_, w| unsafe { w.tim3rm().bits(Self::REMAP)}}),
    Tim3FullRemap: (pac::TIM3, 0b11, PC6, PC7, PC8, PC9, {|_, w| unsafe { w.tim3rm().bits(Self::REMAP)}}),
);
